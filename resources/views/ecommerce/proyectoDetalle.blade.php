...
<section class="hero-banner">
    ...
    <!-- Contenido -->
    <div class="hero-content">
      <h1 class="text-light" style="text-transform: uppercase !important;">{{ $proyecto->nombre }}</h1>
      {{-- <p>
      ...
      <a href="https://wa.me/51994119444?text=Hola,%20quiero%20más%20información%20sobre%20su%20servicio%20de%20{{ $proyecto->nombre }}." class="btn btn-danger" target="_blank">Contactar a un asesor</a>
    </div>
  </section>
          ...
          <div class="col-12 col-xl-7">
            ...
            <div class="owl-carousel owl-theme">
                <div class="item m-auto text-center d-flex justify-content-center">
                    <img src="{{ asset($proyecto->imagen) }}" class="img-fluid w-75 text-center" alt="">
                </div>
                @if ($proyecto->imagen_detalle)
                    <div class="item m-auto text-center d-flex justify-content-center">
                        <img src="{{ asset($proyecto->imagen_detalle) }}" class="img-fluid w-75" alt="">
                    </div>
                @endif
            </div>
          ...
          <div class="col-12 col-xl-5">
            ...
            <div class="blog-left-sidebar border p-4">
                <div class="blog-categories mb-4">
                    <h5 class="mb-3 fw-bold">Más Proyectos</h5>
                    ...
                    @else
                        <p class="pt-3">No más proyectos disponibles.</p>
                    @endif
