            ...
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{ route('admin.proyecto.index') }}">Lista de Proyectos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('admin.proyecto.create') }}">Nuevo Proyecto</a>
                        </li>
                    </ul>
                    ...
                    <div class="row">
                        <div class="col-xxl-12">
                            <form class="card custom-card" method="POST" action="{{ route('admin.proyecto.store') }}" id="formulario_create_proyecto" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row gy-3 justify-content-between">
                                        ...
                                        <div class="col-xxl-6 col-xl-12">
                                            <div class="card shadow-sm">
                                                <div class="card-body text-center">
                                                    <label for="imagenInput" class="form-label fw-bold">Imagen Portada del Proyecto <b class="text-danger">(Medida recomendada: 1200x1200)</b></label>
                                            ...
                                            <div class="col-xl-12 product-documents-container">
                                                <p class="fw-medium mb-2 fs-14">Banner Principal  <b class="text-danger">( Banner Cabezera )</b> :</p>
                                        ...
                                        <div class="col-xxl-6 col-xl-12">
                                            <div class="row gy-3">
                                                <div class="col-xl-12">
                                                    <label for="input-nombre" class="form-label">Nombre del Proyecto</label>
                                ...
                                <div class="card-footer text-end">
                                    <button type="submit" class="btn btn-primary btn-sm btn-wave waves-effect waves-light">Guardar Proyecto</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <!-- Create Project JS -->
    <script src="{{ asset('admin/assets/js/proyecto/create.js') }}?v={{ time() }}"></script>
@endsection